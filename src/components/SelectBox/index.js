...
const variants = {
  OutlineIndigo51_1: "bg-white_A700 border border-indigo_51 border-solid",
...
const sizes = {
  ...
  lg: "md:pb-[11px] pb-[16px] sm:pb-[8px] sm:pt-[11px] md:pt-[14px] pt-[21px] md:px-[11px] sm:px-[15px] px-[16px]",
};
