          ...
          <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[15px] md:p-[22px] p-[32px] w-[100%]">
            ...
            <Column className="flex flex-col justify-start sm:mb-[222px] md:mb-[287px] mb-[418px] sm:mt-[19px] md:mt-[24px] mt-[36px] sm:mx-[0] pt-[1px] sm:px-[0] sm:w-[100%] w-[88%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
                ...
                />
                <Text
                  className="flex-grow font-normal font-poppins md:ml-[11px] ml-[16px] sm:ml-[8px] not-italic text-bluegray_400"
                  as="h6"
                  variant="h6"
                >
                  Dashboard
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[17px] md:mt-[22px] mt-[32px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mx-[0] sm:px-[0] sm:w-[100%] w-[64%]">
                  <Img
                  ...
                  />
                  <Text
                    className="flex-grow font-normal font-poppins md:ml-[11px] ml-[16px] sm:ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[6px] not-italic text-bluegray_400"
                    as="h6"
                    variant="h6"
                  >
                    Message
                ...
                <Text
                  className="bg-red_600 flex font-bold font-poppins items-center sm:px-[4px] md:px-[5px] px-[8px] rounded-radius50 text-white_A700 w-[24px]"
                  variant="body1"
                >
                  3
                </Text>
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[16px] md:mt-[21px] mt-[31px] sm:mx-[0] pr-[1px] sm:px-[0] py-[1px] sm:w-[100%] w-[39%]">
                ...
                />
                <Text
                  className="flex-grow font-normal font-poppins md:ml-[11px] ml-[16px] sm:ml-[8px] not-italic text-bluegray_800"
                  as="h6"
                  variant="h6"
                >
                  File
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mt-[17px] md:mt-[22px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                ...
                />
                <Text
                  className="flex-grow font-normal font-poppins md:ml-[11px] ml-[16px] sm:ml-[8px] mt-[3px] not-italic text-bluegray_400"
                  as="h6"
                  variant="h6"
                >
                  Calender
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[18px] md:mt-[23px] mt-[34px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[47%]">
                ...
                />
                <Text
                  className="flex-grow font-normal font-poppins md:ml-[11px] ml-[16px] sm:ml-[8px] sm:mt-[2px] md:mt-[3px] mt-[5px] not-italic text-bluegray_400"
                  as="h6"
                  variant="h6"
                >
                  Shop
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[16px] md:mt-[21px] mt-[31px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[62%]">
                ...
                <Text
                  className="font-normal font-poppins mb-[2px] ml-[13px] sm:ml-[6px] md:ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[7px] not-italic text-bluegray_400 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Settings
