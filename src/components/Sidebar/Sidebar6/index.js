        ...
        <div className="">
          <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[15px] md:p-[22px] p-[32px] w-[100%]">
            <Img
              ...
              alt="Logo"
            />
            <Column className="flex flex-col justify-start sm:mb-[287px] md:mb-[370px] mb-[539px] sm:mt-[19px] md:mt-[24px] mt-[36px] sm:mx-[0] pt-[1px] sm:px-[0] sm:w-[100%] w-[88%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[18px] md:mt-[24px] mt-[35px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[43%]">
                ...
                />
                <Text
                  className="flex-grow font-inter font-medium md:ml-[11px] ml-[16px] sm:ml-[8px] text-bluegray_800"
                  as="h6"
                  variant="h6"
                >
                  Cart
