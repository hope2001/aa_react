        ...
        <div className="">
          <Column className="bg-white_A700 flex flex-col items-center justify-start sm:p-[15px] md:p-[22px] p-[32px] w-[100%]">
            <Img
              ...
              alt="Logo"
            />
            <Column className="flex flex-col justify-start sm:mb-[224px] md:mb-[289px] mb-[421px] sm:mt-[19px] md:mt-[24px] mt-[36px] sm:mx-[0] pt-[1px] sm:px-[0] sm:w-[100%] w-[88%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[16px] md:mt-[21px] mt-[31px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[62%]">
                ...
                <Text
                  className="font-inter font-medium mb-[2px] ml-[13px] sm:ml-[6px] md:ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[7px] text-bluegray_800 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Settings
