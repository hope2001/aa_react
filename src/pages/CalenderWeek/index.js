            ...
            <Column className="bg-gray_51 flex flex-col font-poppins justify-end md:p-[15px] sm:p-[15px] p-[23px] w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap font-inter items-center justify-between mb-[1px] sm:mt-[20px] md:mt-[26px] mt-[38px] sm:px-[0] w-[100%]">
                ...
                <Column className="bg-white_A700 flex flex-col items-center sm:mx-[0] sm:p-[15px] md:p-[17px] p-[26px] rounded-radius4 shadow-bs sm:w-[100%] w-[75%]">
                  ...
                  <Column className="flex flex-col items-center justify-start mb-[3px] sm:mt-[15px] md:mt-[20px] mt-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:px-[0] w-[100%]">
                      ...
                      >
                        <Column className="border border-indigo_51 border-solid flex flex-col items-center justify-start p-[14px] md:p-[9px] sm:px-[0] sm:py-[7px] w-[100%]">
                          <Text
                            className="font-normal mb-[2px] not-italic text-bluegray_800 w-[auto]"
                            as="h5"
                            variant="h5"
                          >
                            Sun 2/1
                    ...
                    <Column
                      ...
                      style={{
                        backgroundImage: "url('images/img_group8446.svg')",
                      }}
                    >
                      <Row className="bg-deep_orange_300 flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mb-[285px] md:mb-[368px] mb-[536px] ml-[101px] md:ml-[69px] sm:mx-[0] sm:p-[2px] md:p-[3px] p-[5px] rounded-radius4 sm:w-[100%] w-[14%]">
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-center mb-[4px] ml-[10px] md:ml-[6px] mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[72%]">
                          <div className="bg-white_A700 sm:h-[5px] md:h-[6px] h-[8px] mb-[1px] sm:mt-[2px] md:mt-[3px] mt-[5px] rounded-radius50 sm:w-[4px] md:w-[5px] w-[8px]"></div>
                          <Text
                        ...
                        <Text
                          className="font-normal mb-[4px] sm:ml-[4px] md:ml-[6px] ml-[9px] not-italic text-white_A700 w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          Mêt
